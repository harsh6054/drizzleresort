...
<html lang="en">
<head>
<title>Arthur's Seat Point</title>
<!-- for-mobile-apps -->
    ...
    <body>
		...
		<div class="row inner-sec-w3ls-agileinfo">
			...
			<div class="col-lg-8 left-blog-info text-left">
					<div class="card">
						<a href="images/bg3.jpg">
							<img src="images/bg3.jpg" class="card-img-top img-fluid" alt="">
						</a>
						<div class="card-body">
							<ul class="blog-icons my-4">
								<li>
									
										<span class="fa fa-calendar"></span> Mar 4 .2024
								</li>
								<li class="mx-2">
							...
							<h5 class="card-title ">
								<a href="http://localhost/DrizzleResort/blogs/blog.php">Arthur's Seat Point</a>
							</h5>
							<p class="card-text">Arthur Seat Point is located at a height 1340 m and is surrounded by the deep Savitri gorge on one side and a lush green plateau on the other side. Popularly called as Queen of the Points, Arthur’s Seat Point has been named after Sir Arthur Mallet who was the first man to build a House at this Point.</p>

...
<html lang="en">
<head>
<title>Lingmala Waterfall</title>
<!-- for-mobile-apps -->
    ...
    <body>
		...
		<div class="row inner-sec-w3ls-agileinfo">
			...
			<div class="col-lg-8 left-blog-info text-left">
					<div class="card">
						<a href="images/bg7.jpg">
							<img src="images/bg7.jpg" class="card-img-top img-fluid" alt="">
						</a>
						<div class="card-body">
							<ul class="blog-icons my-4">
								<li>
									
										<span class="fa fa-calendar"></span> Mar 11 .2024
								</li>
								<li class="mx-2">
							...
							<h5 class="card-title ">
								<a href="http://localhost/DrizzleResort/blogs/blog.php">Lingmala Waterfall</a>
							</h5>
							<p class="card-text">The spectacular sight of Lingmala Waterfall is only enhanced during Mansoon. Situated amid a lush green and vibrant atmosphere, the waterfall attract many trekking enthusiasts and nature lovers due to its gorgeous appeal. Lingmala Waterfall constitutes it two waterfalls that confluence at a point, thus forming an oasis. The surrealistic appeal of the place attracts many people.</p>
					...
					<div class="comment-top">
						...
						<div class="comment-bottom">
							<form action="#" method="post">
                                ...
                                <input class="form-control" type="file" name="photo"  required="Please Select Your Photos" style="margin-bottom: 20px;">

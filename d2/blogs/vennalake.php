    ...
    <body>
		...
		<div class="row inner-sec-w3ls-agileinfo">
			...
			<div class="col-lg-8 left-blog-info text-left">
					<div class="card">
						<a href="images/bg4.jpg">
							<img src="images/bg4.jpg" class="card-img-top img-fluid" alt="">
						</a>
						<div class="card-body">
							<ul class="blog-icons my-4">
								<li>
									
										<span class="fa fa-calendar"></span> Mar 1 .2024
								</li>
								<li class="mx-2">
								...
								<li>
										...
										<span class="fa fa-eye"></span> 201
								</li>

							</ul>
							<h5 class="card-title ">
								<a href="http://localhost/DrizzleResort/blogs/blog.php">Venna Lake</a>
							</h5>
							<p class="card-text">Venna Lake is a scenic man-made lake in Mahabaleshwar. There is Horse Riding also available. There are number of eateries around the lake Famous for street food like corn, bhelpuri, panipuri. The lake is spread over an area of 28acres with a periphery of 7 to 8 km. The best boating experience is in the Evening with the Sunset. Timing – 9 AM to 7 PM</p>

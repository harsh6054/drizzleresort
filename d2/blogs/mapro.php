    ...
    <body>
		...
		<div class="row inner-sec-w3ls-agileinfo">
			...
			<div class="col-lg-8 left-blog-info text-left">
					<div class="card">
						<a href="images/bg6.jpg">
							<img src="images/bg6.jpg" class="card-img-top img-fluid" alt="">
						</a>
						<div class="card-body">
							<ul class="blog-icons my-4">
								<li>
									
										<span class="fa fa-calendar"></span> Mar 10 .2024
								</li>
								<li class="mx-2">
							...
							<h5 class="card-title ">
								<a href="http://localhost/DrizzleResort/blogs/blog.php">Mapro Garden</a>
							</h5>
							<p class="card-text">Mapro makes fruits-based supplies. There’s choclate factory, restaurant cum cafe, a quant nursery and a children’s play area along with a retail outlet that sells Mapro products. The cafe serves scrumptious food made out of organic ingredients.Their speciality is the strawberry with whipped cream served with a smack of deliciousness.</p>
